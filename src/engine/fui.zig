...
pub fn Fui(comptime Theme: type) type {
    return struct {
        ...
        renderer: Render,
        pub fn init(buf: *[CONF.SCREEN_W * CONF.SCREEN_H]u32) Self {
            return Self{
        ...
        pub fn draw_text(self: *Self, s: []const u8, x: i32, y: i32, scale: i32, color: u32) void {
            var px = x;
            for (s) |chr| {
        ...
        pub fn draw_text_block(self: *Self, lines: []const [:0]const u8, x: i32, y: i32, line_height: i32, scale: i32, color: u32) void {
            var ay = y;
            for (lines) |line| {
        ...
        pub fn draw_cursor_lines(self: *Self, mouse: Vec2) void {
        ...
        pub fn draw_version(self: *Self) void {
        ...
        fn draw_base_popup(self: *Self, message: [:0]const u8, bg_color: u32) Rect {
        ...
        pub fn info_popup(self: *Self, message: [:0]const u8, mouse: Mouse, bg_color: u32) ?bool {
            // Popup
        ...
        pub fn yes_no_popup(self: *Self, message: [:0]const u8, mouse: Mouse) ?bool {
            // Popup
